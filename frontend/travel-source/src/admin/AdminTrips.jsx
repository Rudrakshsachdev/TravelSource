                            ...
                            <div className={styles.formSection}>
                                ...
                                <div className={styles.inputGroup}>
                                    ...
                                    <div className={styles.textareaWrapper}>
                                        <svg className={styles.textareaIcon} viewBox="0 0 20 20" fill="currentColor">
                            ...
                            {filteredTrips.map((trip) => (
                                <div key={trip.id} className={styles.tripCard}>
                                    <div className={styles.tripImage}>
                                        ...
                                        <div className={`${styles.statusBadge} ${trip.is_active ? styles.statusActive : styles.statusHidden}`}>
                                    ...
                                    <div className={styles.tripContent}>
                                        ...
                                        <div className={styles.tripFeatures}>
                                            <div className={styles.feature}>
                                                ...
                                                <span className={styles.featureValue}>{trip.itinerary?.length || 0}</span>
                                            </div>
                                            <div className={styles.feature}>
                                                <span className={styles.featureLabel}>Highlights:</span>
                                                <span className={styles.featureValue}>{trip.highlights?.length || 0}</span>
                                            </div>
                                            <div className={styles.feature}>
                                        ...
                                        <div className={styles.tripActions}>
                                            ...
                                            <button
                                                className={trip.is_active ? styles.deactivateButton : styles.activateButton}
