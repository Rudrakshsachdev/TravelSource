...
const AdminTrips = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    is_himachal_trip: false,
    show_in_himachal_section: false,
    himachal_display_order: 0,
    himachal_featured_priority: 0,
    is_uttarakhand_trip: false,
    show_in_uttarakhand_section: false,
  ...
  const handleEdit = (trip) => {
    setFormData({
      ...
      is_himachal_trip: trip.is_himachal_trip || false,
      show_in_himachal_section: trip.show_in_himachal_section || false,
      himachal_display_order: trip.himachal_display_order || 0,
      himachal_featured_priority: trip.himachal_featured_priority || 0,
      is_uttarakhand_trip: trip.is_uttarakhand_trip || false,
      show_in_uttarakhand_section: trip.show_in_uttarakhand_section || false,
    ...
    setPriceOptions(Array.isArray(trip.price_options) ? trip.price_options : []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        price_options: priceOptions.filter(o => o.occupancy && o.price),
      };
        ...
        {showForm && (
          <div className={styles.formContainer}>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
                  ...
                  <div className={styles.inputGroup}>
                    <label className={styles.inputLabel} style={{ display: "flex", alignItems: "center", gap: "10px", cursor: "pointer" }}>
                      <input
                        ...
                        checked={formData.is_himachal_trip}
                        onChange={handleCheckboxChange}
                        style={{ width: "18px", height: "18px", accentColor: "#3f9e8f" }}
                      />
                      Himachal Trip
                    ...
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
                      Mark this trip as a Himachal destination
                    </span>
                  </div>
                  ...
                  <div className={styles.inputGroup}>
                    <label className={styles.inputLabel} style={{ display: "flex", alignItems: "center", gap: "10px", cursor: "pointer" }}>
                      <input
                        ...
                        checked={formData.show_in_himachal_section}
                        onChange={handleCheckboxChange}
                        style={{ width: "18px", height: "18px", accentColor: "#3f9e8f" }}
                      />
                      Show in Scrolling Section
                    ...
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
                      Display in the auto-scrolling Himachal showcase
                    </span>
                  </div>
                  ...
                  <div className={styles.inputGroup}>
                    ...
                    <div className={styles.inputWrapper}>
                      ...
                      <input
                        ...
                        type="number"
                        placeholder="0"
                        value={formData.himachal_display_order}
                        onChange={handleChange}
                      />
                    </div>
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
                  ...
                  <div className={styles.inputGroup}>
                    ...
                    <div className={styles.inputWrapper}>
                      ...
                      <input
                        ...
                        type="number"
                        placeholder="0"
                        value={formData.himachal_featured_priority}
                        onChange={handleChange}
                      />
                    </div>
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
              ...
              {/* UTTARAKHAND SHOWCASE SETTINGS */}
              <div className={styles.formSection}>
                <h3 className={styles.sectionTitle}>
                  <svg className={styles.sectionIcon} viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zM8.28 7.22a.75.75 0 00-1.06 1.06L8.94 10l-1.72 1.72a.75.75 0 101.06 1.06L10 11.06l1.72 1.72a.75.75 0 101.06-1.06L11.06 10l1.72-1.72a.75.75 0 00-1.06-1.06L10 8.94 8.28 7.22z" clipRule="evenodd" />
                  </svg>
                  Uttarakhand Showcase
                </h3>
                  ...
                  <div className={styles.inputGroup}>
                    <label className={styles.inputLabel} style={{ display: "flex", alignItems: "center", gap: "10px", cursor: "pointer" }}>
                      <input
                        ...
                        checked={formData.is_uttarakhand_trip}
                        onChange={handleCheckboxChange}
                        style={{ width: "18px", height: "18px", accentColor: "#3f9e8f" }}
                      />
                      Uttarakhand Trip
                    ...
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
                      Mark this trip as an Uttarakhand destination
                    </span>
                  </div>
                  ...
                  <div className={styles.inputGroup}>
                    <label className={styles.inputLabel} style={{ display: "flex", alignItems: "center", gap: "10px", cursor: "pointer" }}>
                      <input
                        ...
                        checked={formData.show_in_uttarakhand_section}
                        onChange={handleCheckboxChange}
                        style={{ width: "18px", height: "18px", accentColor: "#3f9e8f" }}
                      />
                      Show in Scrolling Section
                    ...
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
                      Display in the auto-scrolling Uttarakhand showcase
                    </span>
                  </div>
                  ...
                  <div className={styles.inputGroup}>
                    ...
                    <div className={styles.inputWrapper}>
                      ...
                      <input
                        ...
                        type="number"
                        placeholder="0"
                        value={formData.uttarakhand_display_order}
                        onChange={handleChange}
                      />
                    </div>
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
                  ...
                  <div className={styles.inputGroup}>
                    ...
                    <div className={styles.inputWrapper}>
                      ...
                      <input
                        ...
                        type="number"
                        placeholder="0"
                        value={formData.uttarakhand_featured_priority}
                        onChange={handleChange}
                      />
                    </div>
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
              ...
              <div className={styles.formSection}>
                <h3 className={styles.sectionTitle}>
                  <svg className={styles.sectionIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M16 3H8L4 7V17L8 21H16L20 17V7L16 3Z" /><path d="M8 7V21" /><path d="M16 7V21" /><path d="M4 11H20" /><path d="M4 17H20" />
                  </svg>
                ...
                <div className={styles.formGrid}>
                  <div className={styles.inputGroup}>
                    ...
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
                      Mark this trip as a Backpacking adventure
                    </span>
                  </div>
                  ...
                  <div className={styles.inputGroup}>
                    ...
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
                      Display in the auto-scrolling Backpacking showcase
                    </span>
                  </div>
              ...
              {/* MONSOON GETAWAYS SHOWCASE SETTINGS */}
              <div className={styles.formSection}>
                <h3 className={styles.sectionTitle}>
                  <svg className={styles.sectionIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41" />
                    <path d="M12 8c-2.209 0-4 1.791-4 4s1.791 4 4 4 4-1.791 4-4-1.791-4-4-4z" />
                    <path d="M12 2v2" stroke="#3498db" />
                  </svg>
                  Monsoon Getaways Showcase
                </h3>
                ...
                <div className={styles.formGrid}>
                  <div className={styles.inputGroup}>
                    ...
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
                      Mark this trip for the Monsoon collection
                    </span>
                  </div>
                  ...
                  <div className={styles.inputGroup}>
                    ...
                    <span style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "4px" }}>
                      Display in the auto-scrolling Monsoon showcase
                    </span>
                  </div>
              ...
              <div className={styles.formSection}>
                ...
                <div className={styles.inputGroup}>
                  <p style={{ fontSize: "0.85rem", color: "#64748b", marginBottom: "12px" }}>
                    Set custom prices for different occupancies (e.g., Triple Sharing, Double Sharing). These will replace or supplement the basic base price display.
                  </p>
                  <div className={styles.dynamicListSimple}>
                    {priceOptions.map((opt, idx) => (
                      <div key={idx} style={{ marginBottom: "12px", padding: "12px", background: "#f8fafc", borderRadius: "10px", border: "1px solid #e2e8f0", display: "grid", gridTemplateColumns: "1fr 1fr auto", gap: "10px", alignItems: "center" }}>
                        <div>
                          <label style={{ fontSize: "0.75rem", color: "#64748b", display: "block", marginBottom: "4px" }}>Occupancy Type</label>
                          <input
                            type="text"
                            ...
                            onChange={(e) => {
                              ...
                              updated[idx] = { ...updated[idx], occupancy: e.target.value };
                              setPriceOptions(updated);
                            }}
                          />
                        </div>
                        <div>
                          <label style={{ fontSize: "0.75rem", color: "#64748b", display: "block", marginBottom: "4px" }}>Amount (₹)</label>
                          <input
                            type="number"
                        ...
                        <button
                          type="button"
                          className={styles.removeButtonSmall}
                          onClick={() => setPriceOptions(priceOptions.filter((_, i) => i !== idx))}
                          style={{ marginTop: "18px", justifySelf: "end" }}
                        >
                          <svg viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                    ...
                    <button
                      type="button"
                      className={styles.addButtonSmall}
                      onClick={() => setPriceOptions([...priceOptions, { occupancy: "", price: "" }])}
                    >
                      <svg viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 3a1 1 0 00-1 1v5H4a1 1 0 100 2h5v5a1 1 0 102 0v-5h5a1 1 0 100-2h-5V4a1 1 0 00-1-1z" clipRule="evenodd" />
                      </svg>
