...
import { fetchBikingTrips } from "../../services/api";
import styles from "./BikingTrips.module.css";
...
const BikingTrips = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await fetchBikingTrips();
        ...
        <div className={styles.headerRow}>
          <div className={styles.headerArea}>
            ...
            <h2 className={styles.heading}>
              {config.title || "Adventure on Two Wheels"}
            </h2>
            {config.subtitle && (
          ...
          <div className={styles.navGroup}>
            ...
            <Link to="/biking-trips" className={styles.viewAllBtn}>
              View All
          ...
          <div className={styles.scrollArea} ref={scrollRef}>
            {trips.map((trip) => (
              ...
              >
                ...
                {/* Badge */}
                {trip.is_featured && (
                  <span className={styles.badge}>Live The Ride</span>
                )}
                ...
                <div className={styles.content}>
                  ...
                  <div className={styles.cardFoot}>
                    ...
                    <span className={styles.stars}>
                      ...
                      <span className={styles.reviewCount}>(Biking)</span>
                    </span>
                  </div>
                </div>
              </article>
