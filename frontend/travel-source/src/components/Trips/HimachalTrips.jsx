...
import { fetchHimachalTrips } from "../../services/api";
import styles from "./HimachalTrips.module.css";
...
const HimachalTrips = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await fetchHimachalTrips();
        ...
        <div className={styles.headerRow}>
          <div className={styles.headerArea}>
            ...
            <h2 className={styles.heading}>
              {config.title || "Wonders of Himachal"}
            </h2>
            {config.subtitle && (
          ...
          <div className={styles.navGroup}>
            ...
            <Link to="/himachal-pradesh" className={styles.viewAllBtn}>
              View All
              ...
              >
                ...
                <div className={styles.content}>
                  ...
                  <span className={styles.locChip}>
                    <PinIcon />
                    {trip.location || "Himachal"}
                    {trip.state && trip.state.toLowerCase() !== "himachal pradesh" ? `, ${trip.state}` : ""}
                  </span>
