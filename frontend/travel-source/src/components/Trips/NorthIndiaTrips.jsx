...
import { fetchNorthIndiaTrips } from "../../services/api";
import styles from "./NorthIndiaTrips.module.css";
...
const NorthIndiaTrips = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await fetchNorthIndiaTrips();
        ...
        <div className={styles.headerRow}>
          <div className={styles.headerArea}>
            ...
            <h2 className={styles.heading}>
              {config.title || "Explore Epic North India"}
            </h2>
            {config.subtitle && (
          ...
          <div className={styles.navGroup}>
            ...
            <Link to="/north-india-trips" className={styles.viewAllBtn}>
              View All
...
export default NorthIndiaTrips;
