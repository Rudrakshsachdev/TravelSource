...
/* ═══════════════════════════════════════════════════════════════
   Monsoon Getaways Homepage Section
   (Layout matched with India Trips & Summer Getaways)
   ═══════════════════════════════════════════════════════════════ */
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.headerRow}>
          ...
          <div className={styles.navGroup}>
            ...
            <Link to="/monsoon-getaways" className={styles.viewAllBtn}>
              View All
