...
import { fetchAdventureTrips } from "../../services/api";
import styles from "./AdventureTrips.module.css";
...
const AdventureTrips = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await fetchAdventureTrips();
        ...
        <div className={styles.headerRow}>
          <div className={styles.headerArea}>
            ...
            <h2 className={styles.heading}>
              {config.title || "Epic Adventure Journeys"}
            </h2>
            {config.subtitle && (
          ...
          <div className={styles.navGroup}>
            ...
            <Link to="/adventure-trips" className={styles.viewAllBtn}>
              View All
