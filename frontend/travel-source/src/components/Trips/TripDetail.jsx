        ...
        return (
            <div className={styles.loadingContainer}>
                <div className={styles.loadingContent}>
                    ...
                    <p className={styles.loadingSubtitle}>Loading all the details for your perfect adventure...</p>
        ...
        return (
            <div className={styles.errorContainer}>
                <div className={styles.errorContent}>
                    ...
                    <p className={styles.errorMessage}>{error || "We couldn't find the trip details you're looking for."}</p>
        ...
        <div className={styles.tripDetailPage}>
            ...
            <div className={styles.heroSection} ref={heroRef}>
                <div className={styles.heroImage}>
                    <img
                        src={trip.image || "https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"}
                        alt={trip.title}
                    />
                    ...
                    <div className={styles.heroContent}>
                        <div className={styles.heroHeader}>
                            <div className={styles.tripType}>
                                <span className={styles.tripTypeIcon}>{getTripTypeIcon(trip.title)}</span>
            ...
            <div className={styles.mainContent}>
                                    ...
                                    <div className={styles.reviewsContent}>
                                        <div className={styles.reviewSummary}>
                                            <div className={styles.ratingOverview}>
                                                ...
                                                <div className={styles.ratingCount}>Based on 42 reviews</div>
                                            </div>
                                        </div>
                ...
                <div className={`${styles.bookingColumn} ${isSticky ? styles.sticky : ''}`} ref={bookingCardRef}>
                        ...
                        <div className={styles.bookingForm}>
                            ...
                            <div className={styles.priceSummary}>
                                <div className={styles.summaryRow}>
                                    <span>{trip.price} × {travelers} traveler{travelers > 1 ? 's' : ''}</span>
