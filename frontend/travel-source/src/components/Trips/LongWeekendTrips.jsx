...
import { fetchLongWeekendTrips } from "../../services/api";
import styles from "./IndiaTrips.module.css"; // Reuse existing styles for consistency
...
const LongWeekendTrips = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await fetchLongWeekendTrips();
        if (data.config?.is_enabled && data.trips.length > 0) {
          setConfig(data.config);
          setTrips(data.trips);
        }
      } catch (err) {
        console.error("LongWeekendTrips fetch failed:", err);
      }
        ...
        <div className={styles.headerRow}>
          <div className={styles.headerArea}>
            ...
            <h2 className={styles.heading}>
              {config.title || "Long Weekend Getaways"}
            </h2>
            {config.subtitle && (
          ...
          <div className={styles.navGroup}>
            ...
            <Link to="/long-weekend-trips" className={styles.viewAllBtn}>
              View All
                ...
                <div className={styles.content}>
                  ...
                  <div className={styles.cardFoot}>
                    ...
                    <span className={styles.stars}>
                      ...
                      <span className={styles.reviewCount}>(4.9)</span>
                    </span>
                  </div>
                </div>
              </article>
...
export default LongWeekendTrips;
