...
import { fetchGirlsTrips } from "../../services/api";
import styles from "./GirlsTrips.module.css";
...
const GirlsTrips = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await fetchGirlsTrips();
        ...
        <div className={styles.headerRow}>
          <div className={styles.headerArea}>
            ...
            <h2 className={styles.heading}>
              {config.title || "All Girls Group Tours"}
            </h2>
            {config.subtitle && (
          ...
          <div className={styles.navGroup}>
            ...
            <Link to="/all-girls-group-tours" className={styles.viewAllBtn}>
              View All
