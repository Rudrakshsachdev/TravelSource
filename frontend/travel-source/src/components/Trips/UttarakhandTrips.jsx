...
import { fetchUttarakhandTrips } from "../../services/api";
import styles from "./UttarakhandTrips.module.css";
...
const UttarakhandTrips = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const data = await fetchUttarakhandTrips();
        ...
        <div className={styles.headerRow}>
          <div className={styles.headerArea}>
            ...
            <h2 className={styles.heading}>
              {config.title || "Devbhoomi Uttarakhand"}
            </h2>
            {config.subtitle && (
          ...
          <div className={styles.navGroup}>
            ...
            <Link to="/uttarakhand" className={styles.viewAllBtn}>
              View All
              ...
              >
                ...
                <div className={styles.content}>
                  ...
                  <span className={styles.locChip}>
                    ...
                    {trip.state && trip.state.toLowerCase() !== "uttarakhand" ? `, ${trip.state}` : ""}
                  </span>
...
export default UttarakhandTrips;
