...
import { fetchAllIndiaTrips } from "../../services/api";
import styles from "./IndiaTripsPage.module.css";
...
const IndiaTripsPage = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const data = await fetchAllIndiaTrips();
        setTrips(data);
      } catch (err) {
        setError(err.message || "Failed to load India trips.");
      } finally {
        setLoading(false);
      }
    })();
    ...
    <div className={styles.pageContainer}>
      ...
      <div className={styles.inner}>
        ...
        <header className={styles.pageHeader}>
          ...
          <h1 className={styles.heading}>Explore All Indian Destinations</h1>
          <p className={styles.subheading}>
            Discover our complete portfolio of premium domestic getaways. 
            From the high Himalayas to the backwaters of Kerala, curated for the ultimate adventure.
          </p>
        </header>
        ...
        {loading ? (
          ...
          <div className={styles.emptyState}>
            ...
            <p>Please check back later for new exclusive destinations within India!</p>
          </div>
        ) : (
          <div className={styles.grid}>
            {trips.map((trip, idx) => (
