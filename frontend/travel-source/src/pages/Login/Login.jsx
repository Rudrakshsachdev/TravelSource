      ...
      <div className={styles.container}>
        ...
        <div className={styles.headerSection}>
          ...
          <p className={styles.subtitle}>
            Sign in to access your travel portfolio and continue your journey
          </p>
        </div>
        ...
        <div className={styles.footer}>
          <div className={styles.securityBadge}>
            ...
            >
              <path
                fillRule="evenodd"
                d="M8 1a3.5 3.5 0 00-3.5 3.5V7H4a2 2 0 00-2 2v4a2 2 0 002 2h8a2 2 0 002-2V9a2 2 0 00-2-2h-.5V4.5A3.5 3.5 0 008 1zm2 6V4.5a2 2 0 10-4 0V7h4z"
                clipRule="evenodd"
              />
            </svg>
