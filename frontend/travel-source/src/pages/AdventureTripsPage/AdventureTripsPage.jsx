...
import styles from "./AdventureTripsPage.module.css";
...
/* ═══════════════════════════════════════════════════════════════
   Adventure Trips Full Page Component
   ═══════════════════════════════════════════════════════════════ */

const AdventureTripsPage = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setError(err.message || "Failed to load adventure trips.");
      } finally {
        setLoading(false);
      }
    })();
    ...
    <div className={styles.pageContainer}>
      ...
      <div className={styles.inner}>
        ...
        <header className={styles.pageHeader}>
          ...
          <h1 className={styles.heading}>Thrilling Adventure Expeditions</h1>
          <p className={styles.subheading}>
            Push your limits with our curated collection of extreme journeys. 
            From mountain peaks to deep jungles, crafted for the ultimate explorer.
          </p>
        </header>
        ...
        {loading ? (
          ...
          <div className={styles.emptyState}>
            <h2>No adventure trips available right now.</h2>
            <p>Please check back later for new exclusive expeditions!</p>
          </div>
        ) : (
          <div className={styles.grid}>
            {trips.map((trip, idx) => (
              ...
              >
                ...
                {/* Badge */}
                {trip.is_featured && (
                  <span className={styles.badge}>Extreme Adventure</span>
                )}
                ...
                <div className={styles.content}>
                  ...
                  <div className={styles.cardFoot}>
                    ...
                    <span className={styles.stars}>
                      ...
                      <span className={styles.reviewCount}>(2.5k+)</span>
                    </span>
                  </div>
                </div>
              </article>
...
export default AdventureTripsPage;
