...
import { fetchAllHimalayanTrips } from "../../services/api";
import styles from "./HimalayanTripsPage.module.css";
...
/* ═══════════════════════════════════════════════════════════════
   Himalayan Treks Full Page Component
   ═══════════════════════════════════════════════════════════════ */

const HimalayanTripsPage = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const data = await fetchAllHimalayanTrips();
        setTrips(data);
      } catch (err) {
        setError(err.message || "Failed to load Himalayan treks.");
      } finally {
        setLoading(false);
      }
    })();
    ...
    <div className={styles.pageContainer}>
      ...
      <div className={styles.inner}>
        ...
        <header className={styles.pageHeader}>
          ...
          <h1 className={styles.heading}>Conquer the High Altitudes</h1>
          <p className={styles.subheading}>
            Discover our complete portfolio of premium Himalayan expeditions. 
            From serene valley trails to challenging summit climbs, designed for every adventurer.
          </p>
        </header>
        ...
        {loading ? (
          ...
          <div className={styles.emptyState}>
            <h2>No Himalayan treks available right now.</h2>
            <p>Please check back later for new high-altitude expeditions!</p>
          </div>
        ) : (
          <div className={styles.grid}>
            {trips.map((trip, idx) => (
                ...
                <div className={styles.content}>
                  ...
                  <div className={styles.cardFoot}>
                    ...
                    <span className={styles.stars}>
                      ...
                      <span className={styles.reviewCount}>(High Altitude)</span>
                    </span>
                  </div>
                </div>
              </article>
...
export default HimalayanTripsPage;
