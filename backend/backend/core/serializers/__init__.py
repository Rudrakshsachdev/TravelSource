...
from .north_india_trip_serializer import NorthIndiaTripSerializer, NorthIndiaSectionConfigSerializer
...
from .long_weekend_serializer import LongWeekendTripSerializer, LongWeekendSectionConfigSerializer
